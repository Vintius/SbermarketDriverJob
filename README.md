...
Просмотр проекта: https://vintius.github.io/SbermarketDriverJob/  
...
* скачайте сборку с помощью [Git](https://git-scm.com/downloads): ```git clone https://github.com/Vintius/SbermarketDriverJob.git```
* установите ```gulp``` глобально: ```yarn global add gulp-cli```
* перейдите в скачанную папку со сборкой: ```cd SbermarketDriverJob```
